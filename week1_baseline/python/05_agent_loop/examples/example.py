#!/usr/bin/env python3
"""
Boukensha Step 5: Agent Loop Example

This example demonstrates the complete agent loop with tool calling.
The agent will read and summarize the README file using the registered tools.
"""
...
def main():
    ...
    # From example.py: .parent (examples) → .parent (05_agent_loop) → .parent (python) → .parent (week1_baseline) → .parent (repo root)
