...
"""
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            servers: Optional dict mapping server name to tool count
        """
    ...
    def _servers_status_string(self) -> str:
        ...
        Returns:
            Status string like "mud (26)  filesystem (10)" or "(none configured)"
        """
    ...
    def _banner(self) -> str:
        ...
        # Servers status
        servers_line = self._servers_status_string()
