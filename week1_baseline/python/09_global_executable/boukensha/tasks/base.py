...
class Base(ABC):
    ...
    def max_iterations(cls, settings: Dict[str, Any]) -> int:
        ...
        Returns:
            Max iterations value from settings, or DEFAULT_MAX_ITERATIONS
        """
    ...
    def max_output_tokens(cls, settings: Dict[str, Any]) -> int:
        ...
        Returns:
            Max output tokens value from settings, or DEFAULT_MAX_OUTPUT_TOKENS
        """
    ...
    def _integer_setting(cls, settings: Dict[str, Any], key: str, default: int) -> int:
        """
        Fetch an integer setting with default fallback.
        ...
        Returns:
            Integer value from settings or default
        """
